...
def page(title, body, guild_id=0):
    ...
    nav=[
        ...
        ("👤 User Lookup",f"/dashboard/user{q}"),("🧩 Setup",f"/dashboard/setup{q}"),("⚙️ Settings",f"/dashboard/settings{q}"),("🩺 Health",f"/dashboard/health{q}")
    ]
...
.stat{{font-size:28px;font-weight:900}}.muted{{color:#94a3b8}}table{{width:100%;border-collapse:collapse}}td,th{{border-bottom:1px solid #243044;padding:9px;text-align:left;vertical-align:top}}input,select,button,textarea{{padding:10px;border-radius:10px;border:1px solid #334155;background:#020617;color:#fff;box-sizing:border-box}}button,.btn{{background:#7c3aed;color:white;text-decoration:none;border:0;display:inline-block;padding:10px 14px;border-radius:12px}}.ok{{color:#4ade80}}.bad{{color:#f87171}}code{{background:#020617;border-radius:8px;padding:2px 6px}}
