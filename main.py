...
class SupportApplyModal(discord.ui.Modal, title="تقديم دعم فني 🎧"):
    ...
    experience_reason = discord.ui.TextInput(
        label="خبرتك وليش تبي الدعم الفني؟",
        placeholder="اكتب خبرتك وسبب رغبتك",
        required=True,
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(
            ...
            description="طلب جديد يحتاج مراجعة الإدارة.",
            color=COLOR_YELLOW
        )
        ...
        embed.add_field(name="🧠 الخبرة والسبب", value=str(self.experience_reason), inline=False)
...
class DisabledReviewView(discord.ui.View):
    def __init__(self):
        ...
        accept_btn = discord.ui.Button(label="قبول مبدئي", style=discord.ButtonStyle.green, emoji="✅", disabled=True)
        reject_btn = discord.ui.Button(label="رفض", style=discord.ButtonStyle.red, emoji="❌", disabled=True)
...
class InterviewDoneView(discord.ui.View):
    ...
    async def interview_done(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        disabled_view.add_item(discord.ui.Button(label="تمت المقابلة", style=discord.ButtonStyle.blurple, emoji="🎙️", disabled=True))
